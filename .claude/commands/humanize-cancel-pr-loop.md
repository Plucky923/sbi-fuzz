...
allowed-tools: ["Bash(/home/plucky/.humanize/humanize/scripts/cancel-pr-loop.sh)", "Bash(/home/plucky/.humanize/humanize/scripts/cancel-pr-loop.sh --force)"]
...
```bash
"/home/plucky/.humanize/humanize/scripts/cancel-pr-loop.sh"
```
